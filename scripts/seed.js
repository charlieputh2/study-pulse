...
const products = [
    { name: 'Study Pulse 10mg', description: 'Premium weight management peptide solution. Laboratory tested for purity.', price: 2500.00, category: 'Weight Management', image_url: 'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&q=80&w=800', featured: true, available: true },
    { name: 'Study Pulse 20mg', description: 'Double strength weight management formula. Enhanced potency.', price: 3500.00, category: 'Weight Management', image_url: 'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&q=80&w=800', featured: true, available: true },
    { name: 'Study Pulse 30mg', description: 'Maximum strength weight management solution. Advanced formula.', price: 4500.00, category: 'Weight Management', image_url: 'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&q=80&w=800', featured: true, available: true },
