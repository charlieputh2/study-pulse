...
DROP FUNCTION IF EXISTS get_lab_tests() CASCADE;
DROP FUNCTION IF EXISTS get_lab_tests(TEXT) CASCADE;
DROP FUNCTION IF EXISTS get_lab_tests(TEXT, TEXT) CASCADE;
DROP FUNCTION IF EXISTS get_lab_tests(TEXT, TEXT, DATE) CASCADE;
DROP FUNCTION IF EXISTS get_lab_tests(TEXT, TEXT, DATE, DATE) CASCADE;
DROP FUNCTION IF EXISTS get_lab_tests(TEXT, TEXT, DATE, DATE, INT) CASCADE;
DROP FUNCTION IF EXISTS get_lab_tests(TEXT, TEXT, DATE, DATE, INT, INT) CASCADE;

DROP FUNCTION IF EXISTS get_lab_test_detail(UUID) CASCADE;

-- Now create the clean simple version
...
-- Test the functions
SELECT 'Clean functions created!' as status;
